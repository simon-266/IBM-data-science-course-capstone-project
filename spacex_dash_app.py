...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        avg = filtered_df['class'].mean()


        fig = px.pie(
            values=[100 - (avg * 100), avg * 100],
...
def get_scatter_chart(entered_site, payload_slider):
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[(spacex_df['Payload Mass (kg)'] > payload_slider[0]) & (spacex_df['Payload Mass (kg)'] < payload_slider[1]) & (spacex_df['Launch Site'] == entered_site)]
